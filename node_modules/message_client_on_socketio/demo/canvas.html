...
<script>
    (function() {
        ...
        var roll = new MessageServiceClient( viewH );

        // add 4 steps to roll
        roll.addStep( MessageServiceClient.chunk( viewH, rollPadding ) );
        roll.addStep( MessageServiceClient.chunk( viewH * 2, rollPadding ) );
        roll.addStep( MessageServiceClient.chunk( viewH, rollPadding ) );
        roll.addStep( MessageServiceClient.chunk( viewH, rollPadding ) );
