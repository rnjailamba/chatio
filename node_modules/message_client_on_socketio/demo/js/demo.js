(function() {
  ...
  // initiate roll
  var roll = MessageServiceClient.DOM( "#wrapper", "#pane", "#steps", ".step", 100 );
  ...
  function track() {
    ...
    roll.on( "step", MessageServiceClient.stepHandler( roll, views, "prev", "next", "curr", true ) );
  ...
  window.addEventListener("resize", function(evt) {
    roll = MessageServiceClient.DOM( "#wrapper", "#pane", "#steps", ".step", 100 );
    track();
    goto(0);
  });
